...
I made this project because working on SMM drivers directly on hardware is problematic. Instead of having to reflash your SPI chip every time you want to test something, now you can just map your SMM payloads through a minimal SMM host and swap them out from disk or even hot reload them from Windows
